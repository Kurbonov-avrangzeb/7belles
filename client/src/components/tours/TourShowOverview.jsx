      ...
      <TourOverview>
        <TourOverviewLeft>
          ...
          <div>
            ...
            <span>Следующий тур</span>{firstDate(startDates)}
          </div>
          <div>
            <AiOutlineClockCircle className='icon' />
            <span>Продолжительность</span>{duration} Дни
          </div>
          <div>
            <FiTrendingUp className='icon' />
            <span>Сложность</span>{capitalized(difficulty)}
          </div>
          <div>
            <FiUser className='icon' />
            <span>Участники </span>{maxGroupSize} Люди
        </div>
        </TourOverviewLeft>
